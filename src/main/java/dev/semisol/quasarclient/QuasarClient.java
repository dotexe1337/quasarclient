...
import dev.semisol.quasarclient.module.damage.Damage;
...
import dev.semisol.quasarclient.module.hologramimage.HologramImage;
...
public class QuasarClient implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        ModuleRegistry.register(new Damage());
        ModuleRegistry.register(new HologramAura());
        ModuleRegistry.register(new HologramImage());
